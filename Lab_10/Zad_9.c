// Zadanie 9
// Napisz program do porównywania plików o nazwach przekazanych jako argumenty. Wynikiem działania programu ma być komunikat że pliki są identyczne, 
// pliki różnią się od znaku nr <nr znaku> w linii <nr znaku linii> lub - gdy jeden z plików zawiera treść drugiego uzupełnioną o jakieś dodatkowe znaki 
...
void main(int argc, char *argv[]){
    ...
    if (argc != 3){
        fprintf(stderr, "Nie poprawne wywolanie. \nUzyj:%s <plik 1> <plik 2>\n", argv[0]);
        exit(1);
    }
